...
public class MontaCrammer3x3Model implements MontaCrammerInterfaceModel {
	...
	public MontaCrammer3x3Model(float x1, float x2, float x3, float y1,
	...
	public void calculaDeltas() {
		this.Crammer3x3.setDeltaX(this.Crammer3x3.getDeterminantes().get(0)
				/ this.Crammer3x3.getDeterminanteSistema());
		this.Crammer3x3.setDeltaY(this.Crammer3x3.getDeterminantes().get(1)
				/ this.Crammer3x3.getDeterminanteSistema());
		this.Crammer3x3.setDeltaZ(this.Crammer3x3.getDeterminantes().get(2)
				/ this.Crammer3x3.getDeterminanteSistema());
	}
