...
public class TelaSobreView extends JFrame {
	...
	public TelaSobreView() {
		...
		int wdwLeft = screenSize.width / 2 - 200;
		...
		try {
			image = ImageIO.read(getClass()
					.getResource("/assets/img/about.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		setIconImage(image);
		...
		// INFO ANHANGUERA:
		JLabel lblLogoAnhanguera = new JLabel(new ImageIcon(this.getClass()
				.getResource("/assets/img/logoAnhanguera.png")));
		...
		JLabel lblAnhanguera = new JLabel(
				"Trabalho desenvolvido para a Anhanguera UniA Unidade III",
				JLabel.CENTER);
		...
		// INFO PROFESSOR:
		JLabel lblProfessorReinaldoSimonelli = new JLabel(
				"Professor Reinaldo Simonelli - Matem\u00E1tica Aplicada II",
				JLabel.CENTER);
		...
		JLabel lblGrupo = new JLabel(
				"Ci\u00EAncias da Computa\u00E7\u00E3o - Integrantes do Grupo 7:",
				JLabel.CENTER);
		...
		// LICENSE:
		JLabel lblLicense = new JLabel(new ImageIcon(this.getClass()
				.getResource("/assets/img/88x31.png")));
		lblLicense.setBounds(147, 510, 111, 42);
		getContentPane().add(lblLicense);

		JLabel lblCreativeCommons = new JLabel(
